...
{ 
  if($_SESSION['userid']){
  $chka="SELECT*FROM  tbl_accdtl WHERE flname='add_ptemployeesalarypay.php' AND userid='$_SESSION[userid]'";
...
<script language="javascript">
 ...
 $(document).ready(function(event){
   $('.sbmt').click(function(){
	 ...
	 $.post('ins_ptempsalaypost_atatime.php',arr,function(result){
...
<p align="center" ><font face="Arial, Helvetica, sans-serif" size="2"><?php if(isset($_GET['msg'])){ echo $_GET['msg']; }?></font></p>
      <form name="MyForm" id="frm" autocomplete="off"  method="post" >
          <div align="center"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="3" id="stdtbl">
            <tr>
              <td height="36" colspan="5" class="style2" style="padding:3px; border-bottom:1px solid #CCCCCC;">PAY PARTTIME FACULTY SALARY &amp; POST INTO ACCOUNTS (<span class="stars">*</span>Mandatory Field) </span></td>
              </tr>
            <tr bgcolor="#F4F4FF">
            ...
            <tr>
              ...
              <td height="34" colspan="3"><select name="accid" id="accid" onkeypress="return handleEnter(this, event)">
                ...
                <?php $hq=$myDb->select("Select * From tbl_accchart Where parentid in('1884')");
