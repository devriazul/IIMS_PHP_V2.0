   ...
   $(document).ready(function(){
 	  $('#addu2').click(function(){
	    var prdtype=$('#prdtype').val();
		    ...
		    var thePopup = window.open("productListPrt.php?prdtype="+prdtype,"Product Information","location=0,titlebar=0,menubar=0,addressbar=no,height=700,width=900","fullscreen=yes" );
...
$().ready(function() {
	...
	$("#prdtype").autocomplete("search_prtype.php", {
		width: 260,
		matchContains: true,
		//mustMatch: true,
		//minChars: 0,
        ...
        <script type="text/javascript">
            $(document).ready(function(){				   
                ...
                function loadData(page){
					...
					$.post("product_pagination.php?page="+page,arr,function(msg){
                           loading_hide();
                           $("#container").html(msg);
					});                    
                }
				...
				$('#searchid').keypress(function(){
				  var arr=$('#frmsrch').serializeArray();
				  $.post("product_pagination.php?page=1",arr,function(msg){
                           $("#container").html(msg);
				  });
...
<div id="top-search-div">
		   <form method="post" id="frmsrch" autocomplete="off" action="#">
		     <label>Product Name </label>
			 <label><input type="text" id="searchid" name="searchid" /></label>
			 <label>Product Type </label>
			 <label><input type="text" id="prdtype" name="prdtype" /></label>
			 ...
			 <label><input type="button" id="addu2" name="addu2" value="Print View" style="color: #999999; font-size: 8pt; font-family: Verdana; border: 1px solid #C0C0C0; background-color: #D9F0FB; height:20px;"></label>
		   </form>
		   </div> 
           <div id="content">
