...
$().ready(function() {
	$("#searchid").autocomplete("search_prtype.php", {
		width: 260,
		matchContains: true,
		//mustMatch: true,
		//minChars: 0,
        ...
        <script type="text/javascript">
            $(document).ready(function(){				   
                ...
                function loadData(page){
					...
					$.post("followers_list.php?page="+page,arr,function(msg){
                                loading_hide();
                                $("#container").html(msg);
					});                   
                }
				...
				$('#searchid').keyup(function(){
					var arr=$('#frmsrch').serializeArray();
					$.post("followers_list.php?page=1",arr,function(msg){
                                $("#container").html(msg);
					});                   
				});     
 ...
 $(document).ready(function(){
 	  $('input[name=addu2]').click(function(){
	    var searchid=$('#searchid').val();
		    ...
		    var thePopup = window.open('reports/PrdRgstRpt.php?searchid='+searchid,"Stock Status","location=0,titlebar=0,menubar=0,addressbar=no,height=700,width=900","fullscreen=yes" );
