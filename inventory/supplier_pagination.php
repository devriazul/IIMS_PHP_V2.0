...
<?php 
     $sdq="SELECT * FROM tbl_supplier WHERE sname LIKE '$searchid%' order by id desc LIMIT $start, $per_page";
	 $sdep=$myDb->dump_query($sdq,'edit_supplier.php','del_supplier.php',$car['upd'],$car['delt']);
?>
...
<?php 
 /* --------------------------------------------- */
 $msg='';
$query_pag_num = "SELECT COUNT(*) AS count FROM tbl_supplier WHERE sname LIKE '$searchid%'";
