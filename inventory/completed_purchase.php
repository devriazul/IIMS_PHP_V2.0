...
$(document).ready(function(){
  ...
  $('#submit-btn').click(function(){  
		  ...
		  //alert(searchid);
  		  $('#MyRes').load("reqid_wise_completed_purchase.php?reqid="+searchid);
		  $('#allReqRec').fadeOut("slow");
...
$().ready(function() {
	$("#searchid").autocomplete("search_completed_purchase.php", {
		width: 260,
		matchContains: true,
		//mustMatch: true,
		//minChars: 0,
        ...
        <script type="text/javascript">
            $(document).ready(function(){				   
                ...
                function loadData(page){
                    ...
                    ({
                        type: "GET",
                        url: "requisition_pagination.php",
                        data: "page="+page,
					  //  data:$("form").serialize(),
...
<div id="top-search-div"> 
		   <form method="post" autocomplete="off" action="">
		     <label>Enter Requisition ID</label>
             		 
             <label><input type="text" id="searchid" name="searchid" onKeyPress="return handleEnter(this, event)"  /></label>
		 ...
		 <div id="top-search-div"> 
		   ...
		   <form method="post" autocomplete="off" action="requisition1.php">
			 ...
			 <label><a href="add_requesition.php"><input type="button" name="addbtn" id="submit-btn" value="Add Requisition" /></a></label>
			 <label><a href="approveProduct_list.php"><input type="button" name="addbtn" id="submit-btn" value="Approve Requisition" /></a></label>
			 <label><a href="purchaseProduct_list.php"><input type="button" name="addbtn" id="submit-btn" value="Purchase Product" /></a></label>
			 <label></label>
		   </form>
		   </div>
		 </div>
    ...
    <div id="showpick" style=" position:absolute;width:400px; height:500px; float:right; height:auto;margin-top:-50px; left:650px;"></div>
		...
		<br />
		 ...
		 <div id="error"></div>
		<div id="allReqRec" style="width:700px;">
