...
<p align="center" ><font face="Arial, Helvetica, sans-serif" size="2"><?php if(isset($_GET['msg'])){ echo $_GET['msg']; }?></font></p>
	 ...
	 $sdq="SELECT c.id id,p.pname 'Product Name',s.sname 'Supplier Name',c.rqty 'Requisition Qty',c.aqty 'Approve Qty',c.pqty 'Pursase Qty',c.iqty 'Issue Qty'
	       FROM tbl_buyproduct c
		   INNER JOIN tbl_product p
		   ON p.id=c.pid
		   INNER JOIN tbl_supplier s
		   ON c.supid=s.id
WHERE p.pname LIKE '%$searchid%' order by c.id desc";
	$sdep=@$myDb->dump_requisition($sdq,'edit_requisition.php','del_requisition.php',$car['upd'],$car['delt'],'add_approve.php');
	?>
</td>
      </tr>
	        <tr>
