...
{ 
  ...
  $stm=$myDb->select("SELECT storeid FROM tbl_store WHERE id=(select max(id) from tbl_store)");
  $stmf=$myDb->get_row($stm,'MYSQL_ASSOC');
  $strid=substr($stmf['storeid'],-3,(strlen($stmf['storeid'])));
  $strid=((int)$strid)+1;
  $strid="ST0"."$strid";
...
<table width="1047" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td colspan="3" style="height:30px; border-bottom:1px solid #999999; ">Add Store </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td width="91">Store Code</td>
    <td width="5">:</td>
    <td width="402"><label>
      <input type="text" name="storeid" id="storeid" onkeypress="return handleEnter(this, event)" value="<?php echo $strid; ?>" readonly="true" />
    </label></td>
  </tr>
  <tr>
    <td>Store Name</td>
