...
{ 
  if($_SESSION['userid']){
  $chka="SELECT*FROM  tbl_accdtl WHERE flname='assign_crs_teachers.php' AND userid='$_SESSION[userid]'";
...
<div id="top-search-div"> 
           <div id="content">
		   <label>Add Course Teachers </label>
		   <div class="input">
		...
		<form name="MyForm" id="MyForm" autocomplete="off" action="add_depname.php" method="post" onsubmit="xmlhttpPost('ins_depname.php', 'MyForm', 'MyResult', '<img src=\'loader.gif\'>'); return false;">
          ...
          <table width="750" border="0" align="center" cellpadding="0" cellspacing="3" id="stdtbl">
            ...
            <tr>
              <td height="20" colspan="2" class="style2" style="padding:3px; border-bottom:1px solid #CCCCCC;">ASSIGN COURSE TEACHERS </td>
            ...
            <tr>
              <td width="20%" height="20" class="style2">Faculty ID :<span class="stars">*</span> </td>
              <td height="20" colspan="3"><input name="facultyid" placeholder="Faculty ID" type="text" id="facultyid" style="font-family: Verdana; font-size: 8pt; border: 1px solid #3399FF; width:35px;" onkeypress="return handleEnter(this, event)" />
                <input name="fname" type="text" id="fname" style="font-family: Verdana; font-size: 8pt; border: 1px solid #3399FF" placeholder="Department Name" onkeypress="return handleEnter(this, event)" size="50" /></td>
              </tr>
            <tr>
              <td height="20" class="style2">Admission Fee :<span class="stars">*</span></td>
              <td width="35%" height="20"><input name="admissionfee" type="text" id="admissionfee" style="font-family: Verdana; font-size: 8pt; border: 1px solid #3399FF" onkeypress="return handleEnter(this, event)" size="29" /></td>
              <td width="14%"><span class="style2">Lab Fee :</span></td>
              <td width="31%"><input name="labfee" type="text" id="labfee" style="font-family: Verdana; font-size: 8pt; border: 1px solid #3399FF" onkeypress="return handleEnter(this, event)" size="29" /></td>
            </tr>
