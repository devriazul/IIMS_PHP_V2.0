...
$(document).ready(function(){
 $('#B1').click(function(){   
   ...
   $.post("ins_schedule_day.php",arr,function(r){
     $('#shw').html(r);
	 $('#MyForm').submit();
...
$(document).ready(function(){
  $('a[name="dlt"]').unbind().click(function(e){
	...
	if(checkstr == true){	
		$.get("delscheduleday.php?id="+id,function(r){
			if(rows>1){
...
<form name="MyForm" id="MyForm" autocomplete="off" action="#" method="post" >
          ...
          <table width="600" border="0" align="center" cellpadding="0" cellspacing="3" id="stdtbl">
            ...
            <tr>
              ...
              <td width="35%" height="20"><input name="dyname" type="text" id="dyname" placeholder="Schedule day name" style="font-family: Verdana; font-size: 8pt; border: 1px solid #3399FF" onkeypress="return handleEnter(this, event)" size="29" /></td>
              <td colspan="2">&nbsp;</td>
              </tr>
            <tr>
          ...
          <br />
			 ...
			 <br/>
				...
				<?php 
				   $sdq="SELECT*FROM tbl_schedule_day ORDER BY orderid ASC";
   				   $sdep=$myDb->dump_query($sdq,'#','#','y','y');
